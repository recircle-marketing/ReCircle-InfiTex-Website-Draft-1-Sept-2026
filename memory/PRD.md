...
- Floating WhatsApp button (2026-09-11): fixed bottom-right WhatsApp green button (#25D366, official glyph SVG) opening wa.me/919537007436 with prefilled message, entrance pop animation, works on desktop + mobile; form toast moved to bottom-left to avoid overlap. Workflow flowchart swapped to client-supplied 2000x2000 square version with square frame.
- Content revision round 2 (2026-09-12): Why Surat copy now says "polyester textile manufacturing" only; Capacity section removed entirely (chapters resequenced 01–10); Buy section heading simplified to "Direct Sales of Material" with formalized body copy; JV logo separator changed to "X"; intro copy now says "textile to textile recycling"; JV partner names + Bharat Tex linked to their sites; 762 MT stat linked to Ministry of Textiles PDF; addresses linked to Google Maps; enquiry reasons now General Enquiry / Buy Recovered Materials / Sell / Supply Raw Materials / Careers / Other.
